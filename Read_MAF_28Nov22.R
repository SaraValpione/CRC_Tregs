...
c<-read.table("TCGA.COAD.maf", sep="\t", quote = "",header=TRUE)#downloaded from dbGap as available in March 2021 (VarScan, public)
r<-read.table("TCGA.READ.maf", sep="\t", quote = "",header=TRUE)#downloaded from dbGap as available in March 2021 (VarScan, public)
colnames(c)
colnames(r)
m<-rbind(c,r)
